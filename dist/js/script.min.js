var showToastAlert=(a,t={})=>{Toastify({text:a,duration:t.duration||2e3,gravity:t.gravity||"top",position:t.position||"left",backgroundColor:t.backgroundColor||"green"}).showToast()},getTestimonialUsersTemplate=(a,t,e)=>`
