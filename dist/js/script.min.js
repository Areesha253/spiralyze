var showToastAlert=(a,t={})=>{Toastify({text:a,duration:t.duration||3e3,gravity:t.gravity||"top",position:t.position||"left",backgroundColor:t.backgroundColor||"green"}).showToast()},getTestimonialUsersTemplate=(a,t,e)=>`
